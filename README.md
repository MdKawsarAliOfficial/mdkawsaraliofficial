...
<table style="font-family: sans-serif; border: 1px solid #ddd; border-collapse: collapse; width: max-content; max-width: 100%;">
    <tbody style="border: 1px solid #ddd; border-collapse: collapse;">
        <tr style="border: 1px solid #ddd; border-collapse: collapse;">
            <td align="center" width="70px" style="border: 1px solid #ddd; border-collapse: collapse; padding: 10px; background-color: #f0f0f0;">
                <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript" target="_blank" rel="noreferrer"> <img style="max-width: 100%;" src="https://raw.githubusercontent.com/devicons/devicon/master/icons/javascript/javascript-original.svg" alt="javascript" width="40" height="40"/> </a> <br> <p style="margin-top: 10px;">JavaScript</p>
            </td>
            <td align="center" width="70px" style="border: 1px solid #ddd; border-collapse: collapse; padding: 10px; background-color: #f0f0f0;">
                <a href="https://nodejs.org" target="_blank" rel="noreferrer"> <img style="max-width: 100%;" src="https://raw.githubusercontent.com/devicons/devicon/master/icons/nodejs/nodejs-original-wordmark.svg" alt="nodejs" width="40" height="40"/> </a> <br> <p style="margin-top: 10px;">NodeJs</p>
            </td>
            <td align="center" width="70px" style="border: 1px solid #ddd; border-collapse: collapse; padding: 10px; background-color: #f0f0f0;">
                <a href="https://expressjs.com" target="_blank" rel="noreferrer"> <img style="max-width: 100%;" src="https://raw.githubusercontent.com/devicons/devicon/master/icons/express/express-original-wordmark.svg" alt="express" width="40" height="40"/> </a> <br> <p style="margin-top: 10px;">Express</p>
            </td>
            <td align="center" width="70px" style="border: 1px solid #ddd; border-collapse: collapse; padding: 10px; background-color: #f0f0f0;">
                <a href="https://www.mongodb.com/" target="_blank" rel="noreferrer"> <img style="max-width: 100%;" src="https://raw.githubusercontent.com/devicons/devicon/master/icons/mongodb/mongodb-original-wordmark.svg" alt="mongodb" width="40" height="40"/> </a> <br> <p style="margin-top: 10px;">MongoDB</p>
            </td>
            <td align="center" width="70px" style="border: 1px solid #ddd; border-collapse: collapse; padding: 10px; background-color: #f0f0f0;">
        ...
        <tr style="border: 1px solid #ddd; border-collapse: collapse;">
            ...
            <td align="center" width="70px" style="border: 1px solid #ddd; border-collapse: collapse; padding: 10px; background-color: #f0f0f0;">
                <a href="https://git-scm.com/" target="_blank" rel="noreferrer"> <img style="max-width: 100%;" src="https://www.vectorlogo.zone/logos/git-scm/git-scm-icon.svg" alt="git" width="40" height="40"/> </a> <br> <p style="margin-top: 10px;">Git</p>
            </td>
            <td align="center" width="70px" style="border: 1px solid #ddd; border-collapse: collapse; padding: 10px; background-color: #f0f0f0;">
                <a href="https://www.figma.com/" target="_blank" rel="noreferrer"> <img style="max-width: 100%;" src="https://www.vectorlogo.zone/logos/figma/figma-icon.svg" alt="figma" width="40" height="40"/> </a> <br> <p style="margin-top: 10px;">Figma</p>
            </td>
        </tr>
    </tbody>
</table>
